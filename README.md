[![Build Status](https://travis-ci.org/andela-rakpan/document-management-system.svg?branch=master)](https://travis-ci.org/andela-rakpan/document-management-system)
